export const PROJECTS = [
  {
    id: 10,
    title: "Revonera",
    description: "An AI-powered global hiring platform. Built using custom gateway and micr-service base arcitecture using FastAPI ",
    techStack: ["LangChain", "ChatGPT", "Python", "MongoDB", "React"],
    image: "/revo.png",
    demoUrl: "https://revonera.com/",
  ...
  },
  {
    id: 9,
    title: "EZYEV",
    description: "A comprehensive platform for electric vehicle management, including charging station integration and user management.",
    techStack: ["Django", "React Native", "PostgreSQL", "Next.js"],
    image: "/ezyev.png",
    codeUrl: "https://github.com/Umair-Rinde",
    stars: 0,
    forks: 0,
