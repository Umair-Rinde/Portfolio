      ...
      <div className="mb-12">
        ...
        <div className="flex flex-wrap gap-8 justify-center">
          {frontendTechs.map((tech, index) => (
            <div
              key={index}
              className="bg-gray-800 p-6 rounded-xl shadow-lg w-60 text-center transform transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-2xl hover:bg-gray-700"
            >
              <div className="w-20 h-20 mx-auto mb-4 relative bg-gray-600 rounded-full flex justify-center items-center shadow-md">
                <Image
